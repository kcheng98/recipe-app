import { defaultAppData, normalizeMealPlan, normalizeNutritionConfig, normalizePlannerConfig } from "./defaults";
...
export function loadAppData(): AppData {
  ...
  try {
    ...
    parsed.mealPlan = normalizeMealPlan(parsed.mealPlan);
